...
StandardDoublePendulumSimulation::StandardDoublePendulumSimulation(
    QObject *parent)
    : SimulationInterface(parent), m1(1.0), m2(1.0), L1(100.0), L2(100.0),
      theta1(M_PI / 2), theta2(M_PI / 2), omega1(0.0), omega2(0.0), g(9.81) {}
...
void StandardDoublePendulumSimulation::getPositions(double &x1, double &y1,
                                                    double &x2,
                                                    double &y2) const {
    x1 = L1 * sin(theta1);
    y1 = L1 * cos(theta1);
...
AlternativeDoublePendulumSimulation::AlternativeDoublePendulumSimulation(
    QObject *parent)
    : SimulationInterface(parent), m1(1.0), m2(1.0), L1(100.0), L2(100.0),
      theta1(M_PI / 2), theta2(M_PI / 2), omega1(0.0), omega2(0.0), g(9.81) {}
...
void AlternativeDoublePendulumSimulation::getPositions(double &x1, double &y1,
                                                       double &x2,
                                                       double &y2) const {
    x1 = L1 * sin(theta1);
    y1 = L1 * cos(theta1);
...
void ThirdDoublePendulumSimulation::getPositions(double &x1, double &y1,
